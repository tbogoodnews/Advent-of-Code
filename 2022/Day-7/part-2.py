...
need_free = 30000000-(70000000 - root.total_nested() )# current free space


l_sizes = [i  for i in root.nested_sizes()  if i > need_free]

print("Delete folder of size:", min(l_sizes))
